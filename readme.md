...
예를 들어 5.4 버전에 대한 PR인 경우에는 [pre-kr-5.4 브랜치](https://github.com/laravelkr/docs/tree/pre-kr-5.4)에서 작업후 보내야 합니다. 각각의 pre-kr-5.x 브랜치에는 kr 디렉토리가 존재하고, 디렉토리 안의 파일들에는 영어와 한국어가 함께 기록되어 있습니다. 이는 검수 이전의 번역의 편의를 위한것입니다. 따라서 가급적 [pre-kr-5.x](https://github.com/laravelkr/docs/tree/pre-kr-5.4) 브랜치에서 PR 작업을 보내주시기 바랍니다. 
